...
$this->title = Terms::translate('manager/index', 'branch');
...
//                            case "S": t = t + "<a href=\"send//" + raw.customerID + "\" title=\"Edit\"><i class=\"mdi mdi-email-send-outline ms-1 me-1 text-success\" style=\"font-size:1.3em\"></i></a>"; break;
                            case "E": t = t + "<a href=\"manager/edit/" + raw.email + "\/" + raw.userID + "\" title=\"'.Terms::translate('edit_customer', 'cabinet').'\">&nbsp;<i class=\"far fa-edit text-success\" style=\"font-size:1.3em\"></i></a>"; break;
     ...
     foreach ($rows as $k => $v) {
         ...
         switch ($sel)
         {
             ...
             case 'icon':
                 ...
                 $js_text .= '"render": function(data, type, raw) { if (data == \'1\') return "<i class=\"fas fa-user mt-2 fa-2xl fs-5 text-info\" title=\"'.(Terms::translate('persona_entrepreneur', 'cabinet')).'\"></i>"; else return "<i class=\"fas fa-landmark mt-2 fa-2xl fs-5\" title=\"'.(Terms::translate('persona_juridica', 'cabinet')).'\"></i>"; }'."\n";
                 $js_text .= '},'."\n";
